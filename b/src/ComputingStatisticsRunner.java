...
public class ComputingStatisticsRunner {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Average: " + analysis.avgLoan());
       System.out.println("Largest: " + analysis.largestLoan());
       System.out.println("Smallest: " + analysis.smallestLoan());
       System.out.println("Largest Country: " + analysis.largestLoanCountry());
       System.out.println("Smallest Country: " + analysis.smallestLoanCountry());
       System.out.println("Average Days: " + analysis.avgDaysToFund());
       System.out.println("Largest Kenya: " + analysis.largestLoanKenya());
       System.out.println("Average Philippines: " + analysis.avgLoanPhilippines());
       System.out.println("Longest Fund: " + analysis.longestToFundCountry());
       System.out.println("Most Funded: " + analysis.mostLoansFunded());
